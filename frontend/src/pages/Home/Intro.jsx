...
function Intro() {
  return (
    <div className='h-[80vh] bg-primary flex flex-col items-start justify-center gap-8'>
        <h1 className="text-white font-semibold pop-up">Hi , I am</h1>
        <h1 className="text-6xl sm:text-3xl text-secondary font-semibold pop-up">
          Sebona Ifa
        </h1>
        <h1 className="text-5xl sm:text-3xl text-white font-semibold pop-up">
